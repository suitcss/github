...
Looking to contribute something to this repo? Here's how you can help.
...
4. Please try to be as detailed as possible in your report. Include specific
   ...
   and version, version of the package – and steps required to reproduce the issue.
...
this will run the mocha test suite and check your syntax
style is consistent with master (using eslint and stylelint)
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git remote add upstream git://github.com/suitcss/<repo-name>
   ```
...
3. Install the dependencies (you must have Node.js
...
This document is a port of https://github.com/flightjs/flight/blob/master/CONTRIBUTING.md <3 to Twitter Inc.
